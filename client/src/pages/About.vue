<script setup></script>
<template>
	<main class="py-20 px-4 max-w-6xl mx-auto">
		<h1 class="text-3xl font-bold mb-4 text-slate-800">About Sahand Estate</h1>
		<p class="mb-4 text-slate-700">
			Sahand Estate is a leading real estate agency that specializes in helping
